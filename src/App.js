...
export default function App() {
  ...
  const goBack = () => {
    setDirection(-1);
    switch (stage) {
      case "onboarding": setStage("role"); break;
      case "degree": setStage("start"); break;
      case "branch": setStage("degree"); break;
      case "role": setStage("branch"); break;
      case "level": setStage("onboarding"); break;
      case "interview": setStage("level"); break;
      case "report": setStage("interview"); break;
      case "finalIntro": setStage("report"); break;
      case "final": setStage("finalIntro"); break;
      case "finalReport": setStage("final"); break;
      case "finalTips": setStage("finalReport"); break;
  ...
  switch (stage) {
    case "start":
      content = <StartPage onNext={(nextStage) => {
        setDirection(1);
        setStage(nextStage);
      }} />;
      break;
